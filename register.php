 ...
 //mysql_query("select Enrollment_no,Faculty_no from 'verifystudent';");
    ...
    try{
       if($res= mysqli_query($connection,$register_query)){
           ...
           ?> <script type="text/javascript"> alert(" You successfully reistered");</script><?php
           ...
           ?> <script type="text/javascript"> alert(" You already registered");</script><?php
                ...
                header("refresh:0; url=sturegisterb.php");
    exit();
...
background-color: white;
    ...
    <body>
        ...
        <br>
                ...
                <!-- Student Registation -->
                <form action="/implemen/sturegisterb.php" method="POST" name="myform" onsubmit="return validateform()">
